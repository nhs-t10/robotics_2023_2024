...
public class OmniDriveCoefficients {
    ...
    public final CoefficientSet vertical = new CoefficientSet(new double[] {1, 1, 1, 1});
    public final CoefficientSet horizontal = new CoefficientSet(new double[] {-1, 1, 1, -1});
    public final CoefficientSet rotational = new CoefficientSet(new double[] {-1, 1, -1, 1});
