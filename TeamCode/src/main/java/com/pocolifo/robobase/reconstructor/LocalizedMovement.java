...
public class LocalizedMovement {
    ...
    public LocalizedMovement(NovelMecanumDriver drive, PathFinder pathFinder, LocalizationEngine localizer) {
        this(drive, pathFinder, localizer, 8.0);
    }

    public LocalizedMovement(NovelMecanumDriver drive, PathFinder pathFinder, LocalizationEngine localizer, double maxSpeed) {
        this.drive = drive;
