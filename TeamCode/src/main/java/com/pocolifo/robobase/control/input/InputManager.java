...
import com.pocolifo.robobase.control.input.buttonhandles.AButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.BButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.BackButtonHandle;
...
import com.pocolifo.robobase.control.input.buttonhandles.CrossButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.DpadDownButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.DpadLeftButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.DpadRightButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.DpadUpButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.GuideButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.LeftBumperButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.LeftStickButtonButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.LeftStickXButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.LeftStickYButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.LeftTriggerButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.OptionsButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.PsButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.RightBumperButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.RightStickButtonButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.RightStickXButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.RightStickYButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.RightTriggerButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.ShareButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.SquareButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.StartButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.TouchpadButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.TouchpadFinger1ButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.TouchpadFinger1XButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.TouchpadFinger1YButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.TouchpadFinger2ButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.TouchpadFinger2XButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.TouchpadFinger2YButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.TriangleButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.XButtonHandle;
import com.pocolifo.robobase.control.input.buttonhandles.YButtonHandle;
...
public class InputManager{
    ...
    public enum InputOverlapResolutionMethod {
        BOTH_CHILDREN_CAN_SPEAK, MOST_COMPLEX_ARE_THE_FAVOURITE_CHILD, LEAST_COMPLEX_ARE_THE_FAVOURITE_CHILD
    }
