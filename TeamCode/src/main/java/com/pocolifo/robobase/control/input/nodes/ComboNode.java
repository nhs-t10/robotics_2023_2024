...
public class ComboNode extends InputManagerInputNode {
     ...
     * If you do not want a specific order of inputs, I recommend using an {@link LogicAndNode#LogicAndNode(InputManagerInputNode...) AllNode} instead, which doesn't care about order. <br>
